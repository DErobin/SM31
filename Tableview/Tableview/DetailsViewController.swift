...
class DetailsViewController: UIViewController
{
    ...
    override func viewDidLoad()
    {
        ...
        lblNaam.text = selectedPirate?.name
        lblLife.text = selectedPirate?.life
        lblYears.text = selectedPirate?.yearsActive
        lblCountry.text = selectedPirate?.countryOrigin
        lblComment.text = selectedPirate?.comments
